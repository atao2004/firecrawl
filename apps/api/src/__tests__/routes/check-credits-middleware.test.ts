...
const checkTeamCreditsMock = checkTeamCredits as jest.MockedFunction<
  typeof checkTeamCredits
>;
...
describe("checkCreditsMiddleware – Autumn overage handling", () => {
  beforeEach(() => {
    jest.clearAllMocks();
    checkTeamCreditsMock.mockResolvedValue({
      success: false,
